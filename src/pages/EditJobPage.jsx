...
const EditJobPage = ({editMethod}) => {
    ...
    const[comName, setComName] = useState(job.company.name);
    const[comDesc, setComDesc] = useState(job.company.description);
    const[comEmail, setComEmail] = useState(job.company.contactEmail);
    const[comPhone, setcomPhone] = useState(job.company.contactPhone);
